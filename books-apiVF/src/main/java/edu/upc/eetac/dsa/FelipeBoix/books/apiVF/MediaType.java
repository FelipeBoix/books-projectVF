...
public class MediaType {
    ...
    public final static String AUTHORS_API_AUTHOR = "application/vnd.authors.api.author+json";
    public final static String AUTHORS_API_AUTHOR_COLLECTION = "application/vnd.authors.api.author.collection+json";
